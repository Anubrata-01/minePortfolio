...
import { SiRedux, SiTailwindcss, SiNextdotjs, SiExpress, SiMongodb } from 'react-icons/si';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5">
          {skills.map((skill, index) => (
            <div
              key={index}
              className="  flex flex-col items-center p-5 bg-white rounded-lg shadow-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
            >
